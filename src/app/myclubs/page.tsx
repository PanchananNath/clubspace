        ...
        <div className="content grid grid-cols-3">
          <div className="myclubs ml-5 col-span-1">
            ...
            {/* {rows.map((item, index) => {
              console.log(item);
              return (
                <a key={index} href="#" target="_blank" className="no-underline">
                  <div
                    id="club"
                    className="w-80 h-24 bg-cyan-300 mb-6 rounded-lg text-black flex items-center"
                  >
                    <Image
                      src={item.poster}
                      alt="logo"
                      className="w-20 h-20 rounded-lg relative right-3 ml-6"
                    />
                    <p className="text-xl no-underline text-black">
                      {item.name}
                    </p>
                  </div>
                </a>
            ...
            <div
              id="explore"
              className="w-48 h-7 bg-blue-900 rounded-md text-white relative left-16 flex justify-center items-center cursor-pointer"
            >
