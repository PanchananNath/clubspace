  ...
  {/* <div className="container2  mt-5"> */}
      ...
      {rows.map((item) => {
          ...
          return (
                ...
                <div className="box1 bg-sky-200 rounded-lg p-4 row-span-4 col-span-1" key={item.id}>
                    <div id="header" className="inline-flex gap-5">
                        <img className="w-20 h-20 rounded-md cursor-pointer" src={item.poster} alt="logo"/>
                        <h2 className="mt-6 font-bold text-gray-700 cursor-pointer">{item.name}</h2>
                    </div>
