          ...
          <div className="block">
            <div className="w-96 rounded-md mb-4 p-4">
              <div className="bg-blue-200 rounded-md p-4 mb-2">
                <p className="text-base text-black mb-1 flex items-center justify-center"><FaUser className="mr-2"/>Personal Details/Change Profile Picture</p>
                <div className="flex flex-col items-center justify-center mb-4">
                  <label htmlFor="fileUpload" className="cursor-pointer">
                    <FaUpload className="h-24 w-24 text-gray-600 hover:text-gray-900" />
                ...
                <form>
                  <div className="flex flex-col">
                    <div className="flex items-center border border-gray-400 rounded-md p-2 mb-2 focus:outline-none">
                      ...
                      <input type="text" name="username" className="w-full focus:outline-none" placeholder="Enter Username"/>
                    </div>
                  </div>
                  <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 mx-auto block">Upload</button>
                </form>
              </div>
            </div>
          </div>
