...
import { FaUser, FaEnvelope } from "react-icons/fa"; // Importing Font Awesome user and envelope icons
          ...
          <div className="block">
            <div className="w-96 rounded-md mb-4 p-4">
              <div className="bg-blue-200 rounded-md p-4 mb-2">
                <p className="text-base text-black mb-1 flex items-center"><FaUser className="mr-2"/>Personal Details/Update Email</p>
                <form>
                  <div className="flex flex-col">
                    <div className="flex items-center border border-gray-400 rounded-md p-2 mb-2 focus:outline-none">
                      <FaEnvelope className="mr-2" />
                      <input type="email" name="email" className="w-full focus:outline-none" placeholder="Enter Email Address"/>
                    </div>
                  </div>
                  <button type="submit" className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 mx-auto block">Add Email</button>
                </form>
              </div>
            </div>
          </div>
