...
import { FaUser, FaLock } from "react-icons/fa"; // Importing Font Awesome user and lock icons
          ...
          <div className="block">
            <div className="w-96 rounded-md mb-4 p-4">
              <div className="bg-blue-200 rounded-md p-4 mb-2">
                <p className="text-base text-black mb-1 flex items-center"><FaUser className="mr-2"/>Personal Details/Change Password:</p>
                <div className="flex flex-col">
                  <div className="flex items-center border border-gray-400 rounded-md p-2 mb-2 focus:outline-none">
                    <FaLock className="mr-2" />
                    <input type="password" id="oldPassword" className="w-full focus:outline-none" placeholder="Enter Old Password"/>
                  </div>
                  <div className="flex items-center border border-gray-400 rounded-md p-2 mb-2 focus:outline-none">
                    <FaLock className="mr-2" />
                    <input type="password" id="newPassword" className="w-full focus:outline-none" placeholder="Enter New Password"/>
                  </div>
                  <div className="flex items-center border border-gray-400 rounded-md p-2 mb-2 focus:outline-none">
                    <FaLock className="mr-2" />
                    <input type="password" id="confirmPassword" className="w-full focus:outline-none" placeholder="Confirm Password"/>
                  </div>
                </div>
              </div>
              <button className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600 mx-auto block">Save Changes</button>
            </div>
          </div>
        </div>
      </div>
