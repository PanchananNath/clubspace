...
import { FaUser, FaUpload } from "react-icons/fa"; // Importing Font Awesome user and upload icons
            ...
            <div id="options" className="w-96 bg-blue-200 rounded-md mb-4 p-4">
              <div className="mb-2">
                ...
                <div className="flex flex-col">
                  <input type="file" id="fileUpload" className="w-full border border-gray-400 rounded-md p-2 mb-2 focus:outline-none"/>
                </div>
              </div>
              <button className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Upload</button>
            </div>
          </div>
        </div>
      </div>
