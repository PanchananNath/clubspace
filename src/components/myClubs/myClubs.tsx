...
export default function MyClubs() {
    return (
            <div id="body" className="bg-blue-950 w-screen h-screen m-0 p-0 box-border">
            <div id="main" className="min-h-screen min-w-screen bg-white text-blue-700 font-sans grid grid-cols-5 grid-rows-10">
            {/* <div style={{ zIndex: -1, position: "fixed", width: "w-full", height: "h-full" }}></div> */}
            {/* <Image alt="bg-img" src="/logo.png" width="100" height="100" layout="cover" objectFit= 'cover' /> */}
            {/* <Image alt="logo" src={BgLogo} placeholder="blur" quality={100} fill objectFit="cover" /> */}
                <header className="col-span-full row-span-1">
                    ...
                    <div className="w-fill h-18  flex justify-end pr-10">
                        ...
                        <img src="http://upload.wikimedia.org/wikipedia/commons/d/d4/Cat_March_2010-1a.jpg" alt="profile pic" className="rounded-full h-10 w-10 cursor-pointer"/>
                    </div>
                </header>

                <div className="ml-5 col-start-1 col-span-2 row-span-6">
